...
data_root = '/dataset/xxx/mmdet3d/data/nuscenes/'
sub_dir = ''
...
work_dir = 'outputs/train/unibev_featpred_nus_LC_cnw_256_modality_dropout'

load_from = 'remote_checkpoints/unibev_cnw_256_nus_MD.pth'
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        as_two_stage=False,
        transformer=dict(
            type='UniBEVTransformer_HistoryFeatPredictor',
            embed_dims=_dim_,
...
custom_hooks = [
    dict(type='FreezeParametersHook',
         keep_patterns=['history_decoder', 'history_pts_feat_predictor', 'history_img_feat_predictor'],
         freeze_BN=True,
         priority=70),
