...
work_dir = 'outputs/train/unibev_featpred-CrMdFusionUncert_nus_LC_cnw_256_modality_dropout'

load_from = 'outputs/train/unibev_featpred_nus_LC_cnw_256_modality_dropout/epoch_12.pth'
...
custom_hooks = [
    dict(type='FreezeParametersHook',
         keep_patterns=['cross_modal_module', 
                        ...
                        'history_img_feat_predictor.var_head',
                        'history_pts_feat_predictor.var_head',
                        ],
         freeze_BN=True,
         priority=70),
