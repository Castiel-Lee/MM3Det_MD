# End-to-end training for UniBEV_cat
...
# work_dir = './outputs/train/unibev_cat_dim_128_nus_LC_full'
...
load_from = '../remote_checkpoints/resnet101_centerpoint_pretrained.pth'
# load_from = None
