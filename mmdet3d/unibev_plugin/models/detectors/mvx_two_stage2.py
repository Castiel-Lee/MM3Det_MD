...
class MVXTwoStageDetector2(Base3DDetector):
    ...
    def __init__(self,
        ...
        super(MVXTwoStageDetector2, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        # super(MVXTwoStageDetector2, self).init_weights(pretrained)
        # super(MVXTwoStageDetector2, self).init_weights()
