...
class CrossModalComplementaryModule(nn.Module):
    """
    ...
    def __init__(self,
        ...
        self.img_to_pts_attention = DeformableCrossAttention(
        ...
        self.pts_to_img_attention = DeformableCrossAttention(
            embed_dims=embed_dims,
            num_heads=num_heads,
            num_levels=num_levels,
            num_points=num_points,
...
class DeformableCrossAttention(nn.Module):
    ...
    def forward(self, query, key, value, reference_points, spatial_shapes, 
                level_start_index, bev_pos=None, **kwargs):
        """
        前向传播
