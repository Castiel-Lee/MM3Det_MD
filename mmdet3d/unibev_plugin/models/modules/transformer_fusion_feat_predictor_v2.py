...
class UniBEVTransformer_HistoryFeatPredictor_CrMdFusion_TrainerOnly(BaseModule):
    ...
    def __init__(self,
                 ...
                 pred_cur_fusion_method='learnable',
                 **kwargs):
        super(UniBEVTransformer_HistoryFeatPredictor_CrMdFusion_TrainerOnly, self).__init__(**kwargs)
        ...
        if self.use_cross_modal:
            ...
            from .cross_modal_module import CrossModalComplementaryModule
            self.cross_modal_module = CrossModalComplementaryModule(**cross_modal_config)
        
        # 预测特征与当前特征融合的可学习权重（分模态）
    ...
    def pred_cur_fusion(self, pred_feat, cur_feat, cur_valid=1, modal='img'):
        ...
        """
        if cur_feat.dim() == 4:  # [B, C, H, W] -> [B, H*W, C]
    ...
    def process_predict_pts_img_feats(self, batch_frame_names):
        ...
        return results_pts, results_img, current_feat_pts, current_feat_img
    ...
    def forward(self,
        ...
        results_pts, results_img, current_feat_pts, current_feat_img = self.process_predict_pts_img_feats(batch_frame_names)
        ...
        img_bev_embed_cur = current_feat_img
        pts_bev_embed_cur = current_feat_pts
        ...
        if self.use_cross_modal:
            ...
            img_bev_embed_pred, pts_bev_embed_pred = self.cross_modal_module(
        ...
        self.c_flag, self.l_flag = 1, 1  # reset the flags for full training 
