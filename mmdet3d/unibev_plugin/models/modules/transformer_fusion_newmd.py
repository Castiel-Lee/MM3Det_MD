...
class UniBEVTransformer_NewMD(BaseModule):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(UniBEVTransformer_NewMD, self).__init__(**kwargs)
        ...
        Returns:
            tuple[Tensor]: results of decoder containing the following tensor.
                ...
                - enc_outputs_coord_unact: The regression results \
                    ...
                    otherwise None.
        """
        assert len(kwargs['img_metas']) ==1, 'Only support batch size 1 for now.'
        if kwargs['img_metas'][0].get('valid_modal_flag', False):
            flag_lc = kwargs['img_metas'][0]['valid_modal_flag']
            self.l_flag = flag_lc['lidar']
            self.c_flag = flag_lc['camera'] 
        else:
            self.l_flag = 1
            self.c_flag = 1
